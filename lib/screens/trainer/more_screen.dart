// lib/screens/trainer/more_screen.dart
...
class TrainerMoreScreen extends StatefulWidget {
  const TrainerMoreScreen({Key? key}) : super(key: key);
        ...
        return AlertDialog(
          ...
          content: const Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text(
                'This is a prototype gym management app designed for trainers to manage their clients, workout plans, and diet plans.',
              ),
              SizedBox(height: 16),
